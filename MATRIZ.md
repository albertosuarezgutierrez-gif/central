...
│   └── ... (38 packages total: 26 `module-*` + 12 `core-*`/`brand`/`legal-templates` — ver `docs/ESTRUCTURA.md`; `module-encargo` y `module-revenue` retirados el 29/08/2026 sin consumidor, recuperables de git)
