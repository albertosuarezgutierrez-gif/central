...
| Radar de subastas | Ingiere las alertas del BOE y los comparables de Idealista, enriquece con ficha y Catastro, calcula el coste real, detecta chollos de venta directa por zona, sigue las bajadas de precio y avisa | diaria 06:00–09:00 | Plataforma | `@central/module-subastas` |
