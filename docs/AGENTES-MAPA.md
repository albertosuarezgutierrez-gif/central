...
| Radar de subastas | Ingiere BOE + comparables Idealista, enriquece (ficha, Catastro), calcula coste real, puja máxima y yield con datos propios, detecta chollos/bajadas (avisa SOLO de CASAS desde 26/08/2026), captura adjudicaciones, avisa con botones y vigila la antesala concursal (BORME) | diaria 06:00–09:00 | Plataforma | `@central/module-subastas` |
