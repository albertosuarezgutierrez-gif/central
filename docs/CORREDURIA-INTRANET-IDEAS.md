...
obligación lleva **la fecha del ciclo** pegada: cada ciclo es un aviso distinto y el sello sigue
impidiendo el duplicado dentro del ciclo, que es lo que tiene que impedir.
