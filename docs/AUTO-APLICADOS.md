...
- **2026-08-23** · `docs/CONTEXTO-SESIONES.md` · añadida referencia `(PR #1586)` a la entrada del
  ...
  pendiente de revisión) · pasada ligera diaria, rango 21 commits desde `0958a0e` · commit de esta
  auditoría
...
- **2026-09-06** · `docs/CONTEXTO-SESIONES.md` · 3 entradas añadidas: PR #2297 (teléfonos de siniestros, NULL a propósito por bloqueo de red), PR #2301 (iconos llamar/WhatsApp en renovaciones), PR #2366 (botón del backfill de DNI pedía escribir lo ya escrito) · se habían mergeado sin anotarse · e949c9e79 (hook `persist-memoria.sh`)
- **2026-09-06** · `docs/FUENTES-DE-VERDAD.md` · fila nueva para `apps/asegura-web` (CLAUDE.md raíz + `docs/ASEGURA-MARKETING-PLAN.md`) y para la skill `seo-asegura`; sello `verificado` actualizado · 39 commits del rango tocaban asegura-web sin ninguna fila en el mapa · bc55fbfd0
- **2026-09-06** · `.claude/skills/sivra-maestro/references/contexto-y-agente-huesped.md` · añadido el bloque de MODO NOCHE del agente de huéspedes (PR #2312) · faltaba en la skill pese a ser una pieza mayor del agente · bc55fbfd0
- **2026-09-06** · `.claude/skills/agente-correduria/SKILL.md` · cifra de cartera viva 109→110 pólizas con la regla de dos brazos `esCarteraViva()`; retirada la advertencia sobre `lib/cima.ts`, que ya no existe en el repo desde el 01/09; umbral del cron de avisos ≤109→≤110 · datos duros desactualizados frente a `CLAUDE.md` raíz y `apps/asegura/CLAUDE.md` · 282bc6a41
- **2026-09-06** · `docs/AUDITORIA-2026-09.md` · sección "Pasada PROFUNDA — 06/09/2026" añadida · informe completo de esta pasada (código 100% verde; 1 hallazgo 🔴 de heartbeat; ver PR draft del carril 2) · (este commit)
