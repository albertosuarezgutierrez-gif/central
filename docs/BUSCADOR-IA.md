...
|---|---|---|---|---|
| OpenRouter (primario pasarela — lo vigila SU cron, no este agente) | `deepseek/deepseek-v4-flash` (desde PR 31/08/2026; antes `deepseek/deepseek-chat` = V3, más caro) | `OPENROUTER_API_KEY` / `OPENROUTER_MODEL` | $0,086/$0,17 por M (tope 1€/día) | fuera de scope (cron `ia-director-refresh`) |
