...
- **🧹 LIMPIEZA · revisión correos GitHub + barrido de envs/credenciales muertas — 25/06/2026 — branch `claude/github-noreply-email-review-lbzv7k` · PR draft #512**
  ...
  - **PENDIENTES de Alberto (acciones manuales):** activar 2FA en GitHub · pegar `GH_PAT` nuevo (atajo: directo en Vercel ia-rest hasta que el fix del panel esté en prod) · borrar token `ialimp` en GitHub. Posible recordatorio para mediados de julio (token caduca 25-jul).
