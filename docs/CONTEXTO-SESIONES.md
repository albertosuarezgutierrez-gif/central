...
- **🧾 RENTA 2025 (IRPF) — hilo Asecon/Marta "IRPF 2025" — CERRADO 30/06/2026** *(sesión de charla, sin código; cifras en Gmail/AEAT, NO aquí)*
  - **✅ DECISIÓN FINAL (Alberto, 30/06):** **Socorro se mantiene en Punto y Coma SL** (NO se imputa al IRPF) + declaración de **Alberto y Pilar CONJUNTA** = opción **"sin Socorro / conjunta"** de los borradores → **sale a DEVOLVER**. Es **decisión de Alberto, bajo su responsabilidad**, en contra del criterio de la asesoría (ver postura de Marta abajo).
