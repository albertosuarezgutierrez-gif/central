...
- **🔁 «Sigue habiendo duplicidad» (04/09/2026).** Alberto vio dos Manuel Antonio y dos Pilar Piña Franco en `/correduria`:
  ...
  **`seguros.backfill_dni_plan`** (solo uuids; DDL aplicada) al abrir `/correduria/mantenimiento` → de ahí sale el lote 7
  ...
  Heredia/Rios Vazquez, 366 Martin Verdugo/Verdugo Garcia) → lista `excluidos` en el script. Pendiente el OK de
  Alberto para 602 fusiones (CSV con nombres entregado); después, escribir los 14.148 índices.** Segundo hallazgo: el cron `e2e-smoke`
