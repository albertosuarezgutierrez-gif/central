...
- **🧹 DEDUPE BANCARIO CROSS-ORIGEN (Excel↔PSD2) + facturas DIGI 2026 apuntadas — rama `claude/digimobil-email-accounting-rib70e` — 26/06/2026**
  ...
  - **PENDIENTE:** la factura DIGI de **enero** no tiene cargo en el banco (extracto de enero sin importar); **junio** aún no ha pasado (cargo 29/06). Conciliación 📎 de las DIGI no ejecutada (la dejé documentada en cada apunte).
