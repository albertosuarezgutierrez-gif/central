...
- **💬 AGENTE HUÉSPED SIVRA: contexto del hilo + bucle de re-borrador (ver antes de enviar) — rama `claude/agente-huesped-contexto-reborrador` (PR pendiente) — 26/06/2026**
