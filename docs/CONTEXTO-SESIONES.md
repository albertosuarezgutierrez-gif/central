...
**01/08:** #1194 se mergeó a las 07:44, hora y media DESPUÉS de la pasada de las 06:15, que por eso volvió a
dar 504 con el deploy viejo (`agente_latidos` sigue vacía; la primera pasada con el arreglo es la del 02/08).
Los logs añaden el porqué del 504: los reintentos de `aiExtractInvoice` (NIM timeout, Groq JSON truncado) son
los que se comen los 60 s.
