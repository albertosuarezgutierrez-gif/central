...
- **✅ tarjeta Kutxabank de Pilar (4662032019650302) importada a `movimientos_bancarios` (02/07/2026, solo datos — sin cambios de código).**
  ...
  - **Dudas RESUELTAS por Alberto (02/07/2026, misma sesión):**
    - **IKEA 296,93 €** → `turistico_pisos` confirmado + **amortizable** (mobiliario). **Leroy 192,39 € − dev. 140,64 €** → `turistico_pisos` confirmado, gasto de reparación del año. Ambos como **gasto GENERAL de pisos** (sin `propiedad_id`, decisión de Alberto).
