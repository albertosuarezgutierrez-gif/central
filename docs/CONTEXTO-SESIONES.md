...
- ⚠️ **El proyecto Vercel `asegura-web` se creó FUERA del equipo** (`prj_MnuAvshNZg6vmRsfTkSmiX4RyCj9`, 404 desde el equipo `pisos-turisticos-projects`). No se creó otro para no duplicar: hay que localizarlo o borrarlo y rehacerlo con Root Directory `apps/asegura-web`.
