...
- «Mis contactos» en plegables (`SeccionPlegable`, mismo aspecto que la cartera): legal cerrado con lo esencial en la cabecera, listas con su recuento (abiertas solo si están vacías o fallan), formularios cerrados.
