...
- **✅ CUPS de luz → piso: mapeo persistido en la skill `facturas-correo` + 8 cargos de Endesa imputados (02/07/2026, solo datos + doc).**
  ...
  - Contratos Endesa (altas feb-2026): `130139486193` = **Socorro 24** ✅ (confirmado por los correos «Hola Pilar… SOCORRO 24» ref P26CON…), `130139482171` = **Dúplex** ✅ (ya conocido), y los dos de Bustos Tavera **PROVISIONALES**: `130139685932` = Busto Reform (IZDA) / `130139655504` = Luxury Busto (DCHA) — deducidos por correlación factura↔ocupación (2 periodos coherentes), **Alberto confirmó aplicarlo**; verificar con la primera factura PDF de Bustos que traiga CUPS.
