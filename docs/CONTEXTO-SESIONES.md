...
- **🧾 RENTA 2025 (IRPF) — hilo Asecon/Marta "IRPF 2025" — CERRADO 30/06/2026** *(sesión de charla, sin código; cifras en Gmail/AEAT, NO aquí)*
  ...
  - **Estado:** Alberto **envió él mismo** el correo a Marta con su postura + las preguntas del cálculo neto. **Pelota en el tejado de Asecon** (esperando el número neto IS + coste de extracción). Decisión final CON/SIN Socorro pendiente de esos datos.
