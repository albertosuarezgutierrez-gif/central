...
- **🧾 RENTA 2025 (IRPF) — hilo Asecon/Marta "IRPF 2025" — CERRADO 30/06/2026** *(sesión de charla, sin código; cifras en Gmail/AEAT, NO aquí)*
  - **✅ PRESENTADA (01/07/2026):** declaración **CONJUNTA** (Alberto + Pilar), **A DEVOLVER 2.968,26 €** a la cuenta Kutxabank ****0855. **Socorro quedó en Punto y Coma SL** (NO imputado al IRPF); **Villasís/Dúplex en la renta personal por 18.606,47 € (NETO** — ya descontada comisión + IVA de Booking, en vez del bruto imputado 23.896 €; eso subió la devolución de ~1.156 € a 2.968,26 €). Marta confirmó "no hubo problema" y adjuntó el PDF `SUAREZ GUTIERREZ, ALBERTO Y PILAR PIÑA IRPF 2025 - CONJUNTA.pdf`. **Decisión de Alberto bajo su responsabilidad**, en contra del criterio de la asesoría (ver postura de Marta abajo).
  - **Por qué devuelve (más):** lo que **Booking comunica a Hacienda es BRUTO** (incluye **comisión + IVA**). En Villasís/Dúplex (sí va en el IRPF personal de Alberto): imputado 23.896 € vs cobrado neto real 18.606,47 € → la diferencia (~5.290 €, comisión+IVA) se **deduce** → baja la base → más devolución. Pendiente corregir la **doble imputación de Booking** del Dúplex (aparece también imputado a la SL).
  Marta (Asecon) mandó los **borradores** con dos escenarios para Socorro: **CON Socorro** (Socorro como rendimiento de capital inmobiliario en el IRPF personal, 50/50 — sale a pagar; individual mejor que conjunta) vs **SIN Socorro** (imputación de renta inmobiliaria y los ingresos quedan en Punto y Coma — sale a devolver). Diferencia grande entre ambos.
  - **Postura de Alberto (la que defendió en su correo):** mantener Socorro **a nombre de Punto y Coma**, como siempre. Argumentos: la SL **ya está inactiva desde 2026**; los ingresos de Socorro **ya se declararon por la SL y se adelantó Impuesto de Sociedades**; **todos los gastos del inmueble se imputaron también a la sociedad** (tratamiento coherente). Imputarlos ahora al IRPF = **pagar en renta y, además, volver a tributar para sacar el dinero de una SL que no va a continuar** → doble pago, "no sale la cuenta".
  - **Postura de Marta (asesoría):** Socorro **debe** ir al IRPF personal: sin **contrato de cesión** de la explotación a la SL no puede tributar en el IS, y la **AEAT ya imputa esos ingresos a su nombre** en los datos fiscales (riesgo de paralela). Es la misma línea que ya aplicó en la Renta 2024. (Ver skill `perfil-fiscal`: "ingresar en la SL ≠ tributar en la SL".)
  - **Lo que Alberto le PIDIÓ a Marta (clave para decidir):** el **cálculo NETO conjunto**, no solo el del IRPF — (a) cuánto **recupera/deja de pagar la SL** en su IS 2025 (y efecto en 2024) si se le quita Socorro; (b) **coste de extraer** el dinero de la cuenta de la SL (parte por la cuenta **551 socios** sin tributar + resto vía dividendo, que vuelve a tributar); (c) **timing del IS 2025** (¿presentado o aún a tiempo sin Socorro?).
  - **Otros puntos abiertos del hilo:** **comisiones** — confirmar si los ingresos imputados por la AEAT están **netos o brutos** de comisión Booking/Airbnb (si brutos, hay que deducir comisión como gasto → baja la factura; cotejar con `Reservas_Booking_2025.xlsx`). **Gastos sueltos:** falta certificado de **clases de inglés** (deducción educativa) y aclarar a qué inmueble/actividad van **DIGI, Finetworks, Total Energies**. **IBI Socorro:** ya enviado por Pilar y cuadra (recibo Ayto. Sevilla; el de ~173,36 €/plazo, NO confundir con la tasa de basura de ~19,5 €).
  - **Registro guardado:** nota en Google Drive → carpeta **"Estado entrega hacienda"** de Alberto, doc **"IRPF 2025 — CONJUNTA (PRESENTADA) — REGISTRO"** (`docs.google.com/document/d/16RHUFMRD5Yh807sdAb_rVZHemUXW-G22VhqO1ewuIzM`). Regla duradera añadida a skill `perfil-fiscal` (Booking imputa BRUTO = comisión+IVA → declarar neto; + doble imputación Booking).
  - **PENDIENTES (carry-forward, no perder):**
    1. **Subir el PDF oficial** `SUAREZ GUTIERREZ ... IRPF 2025 - CONJUNTA.pdf` (correo de Marta 01/07) a la carpeta Drive "Estado entrega hacienda" (paso manual de Alberto; no hay tool para bajar adjuntos de Gmail en la sesión).
    2. **Enviar a María Pérez (Asecon)** el **Excel de movimientos BBVA 2025 de Punto y Coma** (lo pidió por correo aparte) — para cuadrar el **descuadre de ~21.692 €** entre lo imputado en datos fiscales (PyC 16.963 + personal 67.269 = 84.232) y lo realmente ingresado en PyC (62.539,38).
    3. **Corregir con Booking la doble imputación** del Dúplex (aparece imputado a la vez al NIF de Alberto y al de la SL).
    4. **Lado sociedad 2025:** definir sobre qué ingresos tributa Punto y Coma en su IS (Socorro se quedó en la SL) — lo cierra Asecon con el Excel del punto 2.
  - **Dato de infra detectado:** en la BD de la plataforma (`movimientos_bancarios`) **no hay cuenta de Punto y Coma cargada** (solo BBVA, 2 Kutxabank, N26 de Alberto) → la contabilidad de la SL (IS, 551, pagos fraccionados) **solo la tiene Asecon**, no es consultable desde la plataforma.
