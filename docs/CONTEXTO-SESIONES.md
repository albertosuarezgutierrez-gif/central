...
acceso a la app». Llave de un solo uso y 72 h en `seguros.portal_enlace_directo` (solo SHA-256; atada al índice ciego del
...
de module-seguros-portal (habría roto el build del portal): Web Crypto. #3422 mergeado (sustitución + aviso a la compañía).
