...
- **✅ tarjeta Kutxabank de Pilar (4662032019650302) importada a `movimientos_bancarios` (02/07/2026, solo datos — sin cambios de código).**
  ...
  - **📬 AVISO PARA `facturas-correo` (pendiente):** Pilar reenvía por email la **factura de IKEA (296,93 €, compra 02/06/2026)**; también llegará la de **Leroy Merlin (192,39 €, con abono de 140,64 €)**. Al verlas: archivar en Drive como deducible de pisos y **conciliar** con los movimientos de la cuenta `💳 Tarjeta Kutxabank Pilar` (`cuenta_bancaria_id b8c4376f-cee9-40b7-a447-a0a2345a1b75`, ambos con nota en `comentario`).
