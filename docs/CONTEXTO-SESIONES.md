...
- **✅ SEMANA TEMÁTICA de contenidos + formato CARRUSEL + look nuevo de Reels (02/07/2026, PRs #692, #696 y #699 mergeados).**
  ...
  - Ideas aparcadas para siguientes tandas: informe semanal de métricas → selector de temas (bucle de aprendizaje), Story de reciclaje al día siguiente, respuestas a comentarios con OK Telegram, calendario de temporada hostelera.
