...
- [x] **2026-07-04 · agente-huésped** · en un borrador de cancelación (reserva 134250232, huésped
  ...
  (`contexto.ts` → ficha). Ya arreglado en la misma tanda (regla "NO EJECUTAS ACCIONES" en
  `decidir.ts` + no re-verificar datos de la reserva), verificado presente en `decidir.ts` en la pasada
  del entrenador. → ✅ procesado 2026-07-19 → sin acción adicional (ya resuelto en
