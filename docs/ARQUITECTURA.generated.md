...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-07-03T19:42:54Z). NO editar a mano.
...
- (03/07/2026) 🆕 contable: modo determinista + 3er proveedor IA Kimi (03/07/2026, rama `claude/ai-accounting-agent-3a9o22`).
- (03/07/2026) 🩹 contable: fallo elegante cuando la IA está saturada (03/07/2026, rama `claude/ai-accounting-agent-3a9o22`).
