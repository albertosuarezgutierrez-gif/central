...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-09-12T11:30:36Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 13 apps · 40 packages · 23 capacidades · 40 skills · 1334 rutas API.
...
- (12/09/2026) MCP Sentinel instalado en modo solo-auditoría (12/09/2026), PR #2780.
...
- (12/09/2026) 🚨 Smoobu SIGUE en 401 tras el fix de HMAC — NO se corrija a "arreglado"
