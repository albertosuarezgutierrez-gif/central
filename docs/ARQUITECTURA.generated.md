...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-07-01T15:46:24Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 7 apps · 34 packages · 23 capacidades · 22 skills · 1012 rutas API.
...
- (01/07/2026) ✅ AUDITORÍA INTEGRAL + HEALTH CHECK CRON (01/07/2026, PR #644 mergeado a main, commit c20f393).
