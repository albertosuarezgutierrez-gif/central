...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-20T02:12:58Z). NO editar a mano.
...
- (18/06/2026) 🟢 fix(ia-rest/blog-seo) + fix(plataforma/banca) + feat(plataforma): Control de Facturas
