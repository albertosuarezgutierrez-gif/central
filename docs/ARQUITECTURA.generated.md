...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-30T21:06:13Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 7 apps · 34 packages · 23 capacidades · 19 skills · 1001 rutas API.
...
- (30/06/2026) ✅ rrhh: logo corporativo + distribución de nóminas PDF con IA (30/06/2026, PR #620 mergeado).
