...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-08-20T07:25:44Z). NO editar a mano.
...
- Lección: un 200 por curl NO prueba que un recurso con CORS funcione.
- Mascotas: NO se admiten.
- «Bercell» se queda fuera
- Hallazgo (carril 2, PR aparte):
- 0 fugas del raíl en las 351 fechas escritas hoy, en los 4 pisos.
- La regla que gobierna todo:
- 🚨 Lección de CI (misma sesión):
- Sin verificar:
- «Bercell»
- Hallazgo:
