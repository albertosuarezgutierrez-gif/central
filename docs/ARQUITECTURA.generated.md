...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-23T13:15:44Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 5 apps · 25 packages · 23 capacidades · 17 skills · 936 rutas API.
...
- (23/06/2026) ✅ TAREA PUNTUAL: contratos de arrendamiento turístico convertidos a Word — branch `claude/admiring-faraday-30epbl`
...
- (23/06/2026) 💶 Mejora bloque Tramos IRPF en /finanzas — PR #451 MERGEADO
