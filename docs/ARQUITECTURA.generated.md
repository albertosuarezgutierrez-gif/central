...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-07-01T07:41:54Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 7 apps · 34 packages · 23 capacidades · 19 skills · 1004 rutas API.
...
- (01/07/2026) ✅ plataforma: control mensual tarjeta de crédito Kutxabank (01/07/2026, PR #626 mergeado a main).
