...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-09-13T05:09:31Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 13 apps · 40 packages · 23 capacidades · 40 skills · 1348 rutas API.
...
- (12/09/2026) 🕵️ Pólizas "zombi" del volcado + revertido un arreglo propio equivocado
