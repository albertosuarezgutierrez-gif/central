...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-07-07T06:12:02Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 7 apps · 34 packages · 23 capacidades · 26 skills · 1045 rutas API.
...
- (07/07/2026) 📧 Pasada `facturas-correo` 07/07/2026 — Apps Script `Facturas a Drive` sigue caído (14 días).
- (06/07/2026) 🔧 Reclasificación HISTÓRICA de gasto personal aplicada A MANO por SQL (06/07/2026, tras mergear #773).
