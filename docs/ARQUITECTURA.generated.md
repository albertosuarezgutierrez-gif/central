...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-09-08T08:11:31Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 13 apps · 40 packages · 23 capacidades · 40 skills · 1314 rutas API.
...
- (08/09/2026) 📲 El WhatsApp de invitación saluda por el NOMBRE DE PILA
...
- (08/09/2026) 🍪 `grupoasegura.es` SÍ mide, y mide bien — aquí se afirmó lo contrario sin haberlo medido
- (07/09/2026) 🩺 `total_count: 0` NO prueba que un run de Actions esté muerto — corregida la tabla de la DECIMOCUARTA
- (08/09/2026) 🗑️ Quitar una póliza aportada se ofrece EN LA LISTA, no solo al final de su ficha
