...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-26T05:21:52Z). NO editar a mano.
...
- (26/06/2026) 🔄 AUDITORÍA DIARIA: nuevo modelo de entrega en DOS CARRILES + avisos Telegram — branch `claude/stale-info-daily-updates-cena38`
