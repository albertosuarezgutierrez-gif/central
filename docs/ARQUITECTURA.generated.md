...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-26T11:08:08Z). NO editar a mano.
...
- (26/06/2026) 💬 AGENTE HUÉSPEDES: "sigue sin tener contexto" — causa raíz y fix (texto plano + modelo) — 26/06/2026 (rama `claude/sevillana-guest-message-dtc93i`)
