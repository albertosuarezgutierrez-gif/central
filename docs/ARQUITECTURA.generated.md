...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-07-02T10:08:44Z). NO editar a mano.
...
- (02/07/2026) 🔍 Diagnóstico: el agente de ventas (`crm-envio-auto` de ia-rest) no envía emails a leads (02/07/2026, solo diagnóstico, sin cambio de código).
