...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-06-18T17:27:47Z). NO editar a mano.
> Se regenera en cada push (`.github/workflows/auditoria.yml`). Es el mapa que una sesión nueva lee del repo.
> Descripciones curadas, agentes y glosario: `apps/plataforma/lib/estructura.ts`. Visual: panel `/admin` → 🗺️ Estructura.

**Resumen:** 4 apps · 18 packages · 23 capacidades · 13 skills · 767 rutas API.

## Apps (verticales)
### ia-rest
- **Módulos que usa:** core-ai, core-fiscal, core-push, core-receipts, module-asn, module-contabilidad, module-crm, module-feedback, module-horario, module-materiales, module-presupuestos, module-proveedores
...
- (16/06/2026) 🧾 `@central/core-receipts`: FASE 1 (fundación) — PR #307 (draft)
