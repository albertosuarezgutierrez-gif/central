...
> **Generado automáticamente** por `scripts/auditar-estructura.mjs` (2026-09-02T19:18:59Z). NO editar a mano.
...
- **Capacidades:** —
- **Tablas (7):** seguros.portal_bien, seguros.portal_canal, seguros.portal_codigo, seguros.portal_consentimiento, seguros.portal_identidad, seguros.portal_poliza_declarada, seguros.portal_vinculo
- **Rutas API:** 3
### housesevillana
- **Módulos que usa:** —
- **Capacidades:** —
