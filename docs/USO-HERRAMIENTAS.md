...
|---|---:|---:|---:|---:|---:|
| `bash` | 100 | 14.420 | 8.984.213 | 0 | 0 |
| `otro` | 98 | 3.770 | 13.872.770 | 6.898.554 | 0 |
| `lectura-directa` | 91 | 3.378 | 6.590.262 | 0 | 0 |
| `mcp:github` | 89 | 3.373 | 3.180.348 | 40.189.014 | 57 |
| `escritura` | 81 | 2.225 | 37.999.943 | 0 | 0 |
| `sql` | 69 | 1.537 | 706.711 | 2.348.760 | 8 |
| `mcp:Claude_Code_Remote` | 56 | 690 | 179.233 | 2.997.396 | 9 |
...
| `agente:agente-architect` | 9 | 38 | 36.307 | 1.108.214 | 0 |
