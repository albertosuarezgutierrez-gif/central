...
|---|---:|---:|---:|---:|---:|
| `bash` | 100 | 14.299 | 8.865.800 | 0 | 0 |
| `otro` | 98 | 3.734 | 13.768.856 | 6.898.554 | 0 |
| `lectura-directa` | 91 | 3.376 | 6.497.594 | 0 | 0 |
| `mcp:github` | 89 | 3.356 | 3.169.367 | 40.189.014 | 57 |
| `escritura` | 81 | 2.213 | 37.940.867 | 0 | 0 |
| `sql` | 69 | 1.531 | 702.934 | 2.348.760 | 8 |
| `mcp:Claude_Code_Remote` | 56 | 679 | 177.691 | 2.997.396 | 9 |
