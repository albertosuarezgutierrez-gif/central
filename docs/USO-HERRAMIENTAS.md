...
|---|---:|---:|---:|---:|---:|
| `bash` | 139 | 18.770 | 12.537.614 | 0 | 0 |
| `otro` | 135 | 4.714 | 16.082.748 | 8.019.557 | 0 |
| `mcp:github` | 124 | 3.944 | 3.523.927 | 42.091.489 | 63 |
| `lectura-directa` | 128 | 3.763 | 7.731.087 | 0 | 0 |
| `escritura` | 107 | 2.453 | 39.722.807 | 0 | 0 |
| `sql` | 93 | 1.961 | 909.564 | 2.348.760 | 8 |
| `mcp:Claude_Code_Remote` | 75 | 893 | 213.243 | 3.171.734 | 10 |
| `mcp:Vercel` | 32 | 381 | 600.618 | 198.719 | 7 |
| `mcp:Booking-com` | 12 | 345 | 1.430.828 | 0 | 0 |
| `mcp:Gmail` | 18 | 265 | 417.825 | 0 | 2 |
| `mcp:Supabase` | 55 | 178 | 19.245 | 0 | 1 |
