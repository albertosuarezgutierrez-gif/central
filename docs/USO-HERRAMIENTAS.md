...
|---|---:|---:|---:|---:|---:|
| `bash` | 96 | 12.561 | 7.422.578 | 0 | 0 |
| `otro` | 94 | 3.282 | 12.541.010 | 6.687.387 | 0 |
| `lectura-directa` | 87 | 3.180 | 5.116.139 | 0 | 0 |
| `mcp:github` | 85 | 3.117 | 3.003.491 | 39.268.254 | 57 |
| `escritura` | 79 | 2.145 | 37.446.728 | 0 | 0 |
| `sql` | 67 | 1.283 | 583.603 | 2.348.760 | 8 |
| `mcp:Claude_Code_Remote` | 53 | 562 | 156.322 | 2.729.511 | 9 |
| `mcp:Vercel` | 24 | 271 | 501.377 | 198.719 | 3 |
| `mcp:Booking-com` | 8 | 248 | 1.006.622 | 0 | 0 |
| `mcp:Gmail` | 13 | 217 | 346.727 | 0 | 2 |
| `mcp:Supabase` | 39 | 105 | 13.827 | 0 | 1 |
| `agente:general-purpose` | 14 | 56 | 40.575 | 652.039 | 0 |
...
| `agente:agente-architect` | 8 | 26 | 29.992 | 948.333 | 0 |
| `agente:Explore` | 11 | 25 | 12.103 | 579.777 | 0 |
| `mcp:OpenSEO` | 1 | 21 | 16.266 | 0 | 0 |
