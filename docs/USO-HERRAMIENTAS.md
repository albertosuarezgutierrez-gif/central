...
|---|---:|---:|---:|---:|---:|
| `bash` | 132 | 18.122 | 12.035.940 | 0 | 0 |
| `otro` | 128 | 4.581 | 15.681.550 | 7.767.652 | 0 |
| `mcp:github` | 117 | 3.855 | 3.471.940 | 41.315.272 | 60 |
| `lectura-directa` | 122 | 3.701 | 7.628.520 | 0 | 0 |
| `escritura` | 101 | 2.425 | 39.336.294 | 0 | 0 |
| `sql` | 87 | 1.835 | 838.027 | 2.348.760 | 8 |
| `mcp:Claude_Code_Remote` | 72 | 870 | 210.544 | 3.171.734 | 10 |
