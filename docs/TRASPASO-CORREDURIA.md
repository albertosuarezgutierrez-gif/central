...
| **N2** | ✅ **HECHO (31/08)** — PR draft [asegura#814](https://github.com/albertosuarezgutierrez-gif/asegura/pull/814): la contraseña purgada del ADR-009 (única aparición en el árbol, verificado). ⚠️ **Sigue en el historial git → hay que ROTARLA en TIREA** (y reutilizaba un dato personal reconocible). Los identificadores del runbook se dejaron (no son contraseñas) | — |
