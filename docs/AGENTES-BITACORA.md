...
- **2026-07-09 · facturas-correo** · hizo: pasada diaria (PR atascado en draft 20 días, recién mergeado) — 3 recibos Stripe/Anthropic Ireland (38,25€ c/u, `seguros`) archivados en Drive, pendientes de cargo bancario; revisó el backlog de 25 ficheros sueltos en `FACTURAS Apartamentos/2026` (Paso 1-bis, 3 agentes en paralelo) — la mayoría eran duplicados de facturas EMASESA/Endesa/Dimitri **ya archivadas y conciliadas en pasadas previas** (no se reprocesaron, evitando duplicados); dudas: 6 casos a "Para tu decisión", casi con certeza superados por las pasadas de facturas-correo del 11/07, 12/07 y 24/07 (email "Aires" de Pilar sin importe legible; CREATE.pdf ventilador y CamScanner Leroy Merlin sin destino claro piso/Monte Carmelo; Escaneado_20260707 ilegible; 2 facturas EMASESA de 2025 de Punto y Coma SL fuera de la carpeta/cuenta personal; Teya_1_original.txt resultó ser transcripción de una llamada comercial, no una factura); fallos: **corte del Apps Script "Facturas a Drive"** — activo desde el 23/06 al 09/07 (16 días), estado actual sin verificar en esta pasada, revisar si sigue vivo; **2 carpetas "07-Julio-2026" duplicadas** en Drive, probablemente aún sin consolidar; PRs/commits: PR #796 (rama `claude/inspiring-gauss-4jxvmm`, creada 09/07, mergeada 29/07 — **lección para el entrenador:** un PR draft de solo memoria puede quedar 20 días sin fusionar si nadie lo revisa; considerar que estas pasadas commiteen directo a `main` en vez de abrir PR, como ya hacen otros agentes)
