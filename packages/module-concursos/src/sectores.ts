...
export const SECTORES: Sector[] = [
  ...
  { id: 'seguridad',       nombre: 'Seguridad y vigilancia',              cpv: ['79.7'] },
  ...
  { id: 'publicidad',      nombre: 'Publicidad y comunicación',           cpv: ['79.34', '92.4'] },
  { id: 'eventos_cultura', nombre: 'Cultura, ocio y deporte',             cpv: ['92', '37.4'] },
