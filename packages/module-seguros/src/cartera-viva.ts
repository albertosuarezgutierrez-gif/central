...
export type EntradaCarteraEnVigor = EntradaCarteraViva & {
  ...
  /** `polizas.sustituida_at`. Con valor, otra póliza ya ocupa su sitio: el cliente no tiene DOS
   *  seguros del mismo coche (caso José Suárez, 23/09/2026). `undefined` = quien llama no lo lee. */
