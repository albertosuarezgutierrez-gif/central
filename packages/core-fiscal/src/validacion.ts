// Validadores fiscales españoles (NIF/NIE/CIF) e IBAN. Funciones puras, sin BD.
// Pensados para "avisar" (no bloquean): solo validan si hay valor. Reutilizables por
// cualquier vertical (ialimp, ia-rest, sivra) en UI o backend.
