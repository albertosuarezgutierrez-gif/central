...
- LLM texto: NVIDIA NIM meta/llama-3.1-70b-instruct (swap 22/08/2026: `z-ai/glm-5.2` murió por EOL real el 21/08/2026 — antes ya habían muerto llama-4-maverick y el 3.3-70b iba a dejar de soportarse; **fallback automático → Groq `openai/gpt-oss-120b`, gratis rate-limited**; Anthropic retirado 17/06/2026, sin saldo)
