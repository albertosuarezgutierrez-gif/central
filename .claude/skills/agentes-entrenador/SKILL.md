...
6. **Mantenimiento y cierre.**
   - Poda de `AGENTES-BITACORA.md`: elimina las entradas procesadas y actualiza "Última
     ...
     23/08 y 30/08 se declararon hechas en su propia nota y las 52 entradas seguían
     íntegras en el archivo un mes después (nadie lo había comprobado hasta la pasada del
     20/09) — mismo fallo que el "cepo que no se ha visto fallar" de `CLAUDE.md`, un piso
