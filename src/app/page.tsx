...
<section class="cap" id="capacidades">
  <div class="w">
    ...
    <div class="cap-grid fi d1">
      ...
      <div class="cap-item"><span class="cap-num">12</span><div class="cap-title">Eventos y catering</div><div class="cap-sub">Bodas, comuniones, empresas. Presupuesto, pases de cocina, APPCC y check-in de invitados.</div></div>
