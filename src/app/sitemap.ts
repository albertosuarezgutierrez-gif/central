...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const estaticas: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/sectores/catering`,                            lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/sectores/eventos`,                             lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/blog/software-gestion-catering-eventos`,       lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    // Landings por tipo de restaurante — SEO + prospección
    { url: `${base}/demo/restaurante-indio`,                       lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/demo/restaurante-mediterraneo`,                lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/demo/grupo-multilocal`,                        lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/demo/catering`,                                lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/demo/tapas-bar`,                               lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
