...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'ia.rest · Gestión completa para catering y eventos', description: 'Presupuestos, menús, proveedores y APPCC. Todo desde un sistema.', url: 'https://www.iarest.es/catering', siteName: 'ia.rest', locale: 'es_ES', type: 'website' },
  alternates: { canonical: 'https://www.iarest.es/catering' },
}
