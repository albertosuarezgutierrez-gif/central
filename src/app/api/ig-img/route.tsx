...
export async function GET(req: NextRequest) {
  ...
  if (tipo === 'pregunta') return new ImageResponse(
    <div style={{width:S,height:S,background:CR,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'serif'}}>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
        <span style={{fontStyle:'italic',fontSize:22,color:INK}}>ia<span style={{color:RED}}>.</span>rest</span>
        <span style={{fontSize:14,color:I2,fontFamily:'sans-serif'}}>{sub||'Hostelería · 2026'}</span>
      </div>
      ...
      <div style={{display:'flex',alignItems:'center',gap:14}}>
        ...
        <span style={{fontSize:18,color:RED,letterSpacing:'0.1em',textTransform:'uppercase',fontWeight:600,fontFamily:'sans-serif'}}>Léelo en el blog →</span>
      </div>
    </div>,{width:S,height:S})

  if (tipo === 'stat') return new ImageResponse(
    <div style={{width:S,height:S,background:DARK,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'sans-serif'}}>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:8}}>
        <div style={{fontStyle:'italic',fontSize:160,color:RED,lineHeight:1,fontWeight:300,fontFamily:'serif'}}>{dato}</div>
        <div style={{fontStyle:'italic',fontSize:34,color:I2,fontFamily:'serif'}}>{unidad}</div>
      </div>
      <div style={{display:'flex',flexDirection:'column',gap:16,borderTop:'1px solid #2E2720',paddingTop:32}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between'}}>
          <span style={{fontStyle:'italic',fontSize:20,color:I3,fontFamily:'serif'}}>ia<span style={{color:RED}}>.</span>rest</span>
  ...
  if (tipo === 'tip') {
    ...
    return new ImageResponse(
      <div style={{width:S,height:S,background:RED,display:'flex',flexDirection:'column',padding:90,justifyContent:'space-between',fontFamily:'serif'}}>
        <span style={{fontSize:12,letterSpacing:'0.15em',textTransform:'uppercase',color:'rgba(246,241,231,0.5)',fontFamily:'sans-serif'}}>{sub||'3 claves · Hostelería'}</span>
        ...
        <div style={{display:'flex',flexDirection:'column'}}>
          <div style={{display:'flex',gap:24,padding:'26px 0',borderBottom:'1px solid rgba(246,241,231,0.18)',alignItems:'flex-start'}}>
            ...
            <span style={{fontSize:24,color:'rgba(246,241,231,0.9)',lineHeight:1.4,fontFamily:'sans-serif',marginTop:8}}>{t0}</span>
          </div>
          <div style={{display:'flex',gap:24,padding:'26px 0',borderBottom:'1px solid rgba(246,241,231,0.18)',alignItems:'flex-start'}}>
            <span style={{fontStyle:'italic',fontSize:52,color:'rgba(246,241,231,0.2)',lineHeight:1,flexShrink:0}}>2</span>
            <span style={{fontSize:24,color:'rgba(246,241,231,0.9)',lineHeight:1.4,fontFamily:'sans-serif',marginTop:8}}>{t1}</span>
          </div>
          <div style={{display:'flex',gap:24,padding:'26px 0',alignItems:'flex-start'}}>
            ...
            <span style={{fontSize:24,color:'rgba(246,241,231,0.9)',lineHeight:1.4,fontFamily:'sans-serif',marginTop:8}}>{t2}</span>
          </div>
        </div>
  ...
  if (tipo === 'comparativa') {
    ...
    return new ImageResponse(
      <div style={{width:S,height:S,background:D2,display:'flex',flexDirection:'column',padding:80,gap:40,fontFamily:'sans-serif'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          <span style={{fontSize:13,letterSpacing:'0.14em',textTransform:'uppercase',color:I3}}>{titulo||'Antes vs ahora'}</span>
          <span style={{fontStyle:'italic',fontSize:18,color:I3,fontFamily:'serif'}}>ia<span style={{color:RED}}>.</span>rest</span>
        </div>
    ...
    return new ImageResponse(
      <div style={{width:S,height:S,background:CR,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'serif'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:4}}>
          <div style={{fontSize:20,fontWeight:600,color:INK,fontFamily:'sans-serif'}}>{nom}</div>
          <div style={{fontSize:16,color:I2,fontFamily:'sans-serif'}}>{loc}</div>
        </div>
        <div style={{display:'flex',alignItems:'center',gap:14}}>
          <div style={{width:48,height:3,background:RED}}/>
  ...
  if (tipo === 'slide') {
    ...
    if (esPortada) return new ImageResponse(
      <div style={{width:S,height:S,background:DARK,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'serif'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',fontFamily:'sans-serif'}}>
    ...
    if (esCierre) return new ImageResponse(
      <div style={{width:S,height:S,background:RED,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'serif'}}>
        <span style={{fontSize:12,letterSpacing:'0.14em',textTransform:'uppercase',color:'rgba(246,241,231,0.5)',fontFamily:'sans-serif'}}>{num} / {total}</span>
        <div style={{display:'flex',flexDirection:'column',gap:20}}>
          <div style={{fontStyle:'italic',fontSize:56,color:CR,lineHeight:1.15}}>¿Lo probamos en tu restaurante?</div>
          <div style={{fontSize:22,color:'rgba(246,241,231,0.7)',fontFamily:'sans-serif'}}>14 días gratis · Sin contrato · Sin comisión</div>
        </div>
    ...
    // Alternar fondos: par=crema, impar=oscuro
    const bg=num%2===0?CR:DARK,textColor=num%2===0?INK:CR,numColor=num%2===0?'rgba(217,68,43,0.1)':'rgba(217,68,43,0.15)'
    return new ImageResponse(
      <div style={{width:S,height:S,background:bg,display:'flex',flexDirection:'column',justifyContent:'space-between',padding:90,fontFamily:'serif'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',fontFamily:'sans-serif'}}>
          <span style={{fontSize:12,letterSpacing:'0.14em',textTransform:'uppercase',color:num%2===0?I3:I3}}>ia.rest · Blog</span>
  ...
  // PRODUCTO (default)
  return new ImageResponse(
    <div style={{width:S,height:S,background:DARK,display:'flex',flexDirection:'column',padding:80,justifyContent:'space-between',fontFamily:'sans-serif'}}>
