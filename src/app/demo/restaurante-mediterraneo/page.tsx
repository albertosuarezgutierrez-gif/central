...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'ia.rest · Gestión completa para restaurantes mediterráneos', description: 'Sala, cocina, almacén, proveedores y eventos. Todo conectado.', url: 'https://www.iarest.es/demo/restaurante-mediterraneo', siteName: 'ia.rest', locale: 'es_ES', type: 'website' },
  alternates: { canonical: 'https://www.iarest.es/demo/restaurante-mediterraneo' },
}
