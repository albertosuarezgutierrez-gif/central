...
export default function Page() {
  ...
  const gestion=[['📦','Stock central','Transferencias entre locales. Visión global.'],['📷','Albaranes por local','Cada recepción registrada con foto.'],['🤝','Proveedores centralizados','Pedidos grupales. Mejores condiciones.'],['🎉','Eventos en todos los locales','Presupuestos y coordinación centralizada.'],['🔮','Previsión por local','La IA anticipa demanda en cada sede.'],['👥','Gestión de personal','Fichajes y turnos para todo el grupo.']]
  const pqItems=['🏢 Grupos de 2 a 20+ locales','🍽 Cadenas de restauración','🎪 Grupos con eventos y catering','📦 Alta rotación de proveedores','👥 Equipos de 10 a 100+ personas','📊 Necesitas visión consolidada']
  return (
    <main style={{background:P,minHeight:'100vh',color:D,fontFamily:SN}}>
      ...
      <section style={{maxWidth:660,margin:'0 auto',padding:'60px 28px'}}>
        <h2 style={{fontFamily:SE,fontSize:30,fontWeight:300,color:D,textAlign:'center',marginBottom:32}}>Para grupos que gestionan más de un local</h2>
