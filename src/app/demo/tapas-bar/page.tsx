...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'ia.rest · Gestión para bares de tapas y raciones', description: 'Comandas por voz, almacén y analytics. Para el ritmo real de un bar.', url: 'https://www.iarest.es/demo/tapas-bar', siteName: 'ia.rest', locale: 'es_ES', type: 'website' },
  alternates: { canonical: 'https://www.iarest.es/demo/tapas-bar' },
}
