...
SELECT v.* FROM (
  ...
  UNION ALL SELECT
    ...
    'Pasaje Villasís 1 / Pasaje Francisco Molina 4, Sevilla', '5029006TG3452G0019BG',
    65.46, 1981,
  ...
  UNION ALL SELECT
    ...
    'Calle Bustos Tavera 22, bajo derecha, Sevilla', NULL, NULL, NULL,
  ...
  UNION ALL SELECT
    ...
    'Calle Bustos Tavera 22, bajo izquierda, Sevilla', NULL, NULL, NULL,
    'turistico', 'alquilado', NULL, NULL, NULL,
    NULL, NULL,
    NULL, NULL,
    true, NULL,
