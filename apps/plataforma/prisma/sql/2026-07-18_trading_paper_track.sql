-- Forward paper (Fase B) · snapshot SEMANAL de cada cohorte congelada vs el SPY.
-- Tabla nueva y AISLADA (no toca tablas/RLS/GRANTs de otras verticales). La escribe el cron
-- `paper-tracker` de forma idempotente (upsert por cohorte+fecha). Solo medición — cero órdenes reales.
