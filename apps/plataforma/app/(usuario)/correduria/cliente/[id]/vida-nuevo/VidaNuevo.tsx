...
// La pantalla de presupuesto de VIDA SIN PÓLIZA («oportunidad nueva»), DENTRO
// de `/correduria` — mismo diseño que el resto del panel (`components/ui.tsx`).
//
// Hermana de `.../moto-nuevo/MotoNuevo.tsx`, pero SIN vehículo que identificar:
...
export default function VidaNuevo({
  ...
  return (
    <div style={{ display: 'grid', gap: 14 }}>
      ...
      <div style={cardStyle}>
        <CardHeader title="1 · El capital" sub="Cuánto quiere que cubra la póliza si fallece dentro del plazo. Lo teclea el corredor: no se supone." />
