    ...
    <div style={{ padding: '24px', maxWidth: 900 }}>
      <style>{`
        @media (max-width: 768px) {
          .empl-filtros { flex-direction: column !important; }
          .empl-filtros input, .empl-filtros select { width: 100% !important; min-width: unset !important; }
          .empl-filtros > div { width: 100% !important; }
          .empl-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        }
      `}</style>
      ...
      <div className="empl-filtros" style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
        <input
      ...
      <div className="empl-table-wrap" style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
