    ...
    <div style={{ padding: '24px', maxWidth: 900 }}>
      <style>{`
        @media (max-width: 768px) {
          .solic-filtros { flex-direction: column !important; }
          .solic-filtros input, .solic-filtros select { width: 100% !important; min-width: unset !important; }
          .solic-card-row { flex-direction: column !important; }
          .solic-card-row > div:last-child { align-self: flex-start !important; }
        }
      `}</style>
      ...
      <div className="solic-filtros" style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
        <input
        ...
        {visibles.map(s => {
          ...
          return (
            <div key={s.id} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, padding: '12px 16px' }}>
              <div className="solic-card-row" style={{ display: 'flex', alignItems: 'flex-start', gap: 10, flexWrap: 'wrap' }}>
                <div style={{ flex: 1 }}>
