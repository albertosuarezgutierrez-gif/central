    ...
    <main style={{ maxWidth: '960px', margin: '0 auto', padding: '32px 24px' }}>
      <style>{`
        @media (max-width: 768px) {
          .crec-grid { grid-template-columns: 1fr !important; }
          .crec-tabs { overflow-x: auto; flex-wrap: nowrap !important; }
          .crec-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        }
      `}</style>
      ...
      {tab === 'instagram' && (
        <div>
          <div className="crec-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '10px', marginBottom: '24px' }}>
            {[
