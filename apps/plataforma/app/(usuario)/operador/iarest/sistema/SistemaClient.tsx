    ...
    <main style={{ maxWidth: '960px', margin: '0 auto', padding: '32px 24px' }}>
      <style>{`
        @media (max-width: 768px) {
          .sistema-grid { grid-template-columns: 1fr !important; }
          .sistema-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        }
      `}</style>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        {lastRun && (
          <div className="sistema-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: '10px', marginBottom: '16px' }}>
            {[
      ...
      {training.global && (
        <div>
          ...
          <div className="sistema-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '10px', marginBottom: '16px' }}>
            {[
