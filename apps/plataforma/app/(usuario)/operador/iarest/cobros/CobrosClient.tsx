    ...
    <main style={{ maxWidth: '960px', margin: '0 auto', padding: '32px 24px' }}>
      <style>{`
        @media (max-width: 768px) {
          ...
          .cobros-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; }
        }
      `}</style>
      <h1 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '24px' }}>💶 Cobros · ia-rest</h1>

      {totales && (
        <div className="cobros-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '12px', marginBottom: '32px' }}>
          {[
