...
// Datos de la pantalla de la limpieza (Si que Brilla) o del preview de Alberto:
  ...
  try {
    const [reservasRaw, limpiezas, tareas, nuevasRaw, huerfanasRaw, canceladasRaw, partesRaw] = await Promise.all([
      ...
      prisma.$queryRaw<Array<{
        ...
        LIMIT 20
      `),
      // Partes de incidencia de la limpieza (nota y/o foto de Si que Brilla sobre una limpieza concreta).
