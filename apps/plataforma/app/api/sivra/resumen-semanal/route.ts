...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    lunes.setDate(hoy.getDate() - hoy.getDay() + 1 - 7)
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px">
  <div style="background:#1B4332;color:white;padding:20px;border-radius:8px;margin-bottom:20px">
    <h2 style="margin:0;font-size:20px">📊 Resumen semanal — Pisos</h2>
