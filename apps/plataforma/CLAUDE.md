...
- 🧮 **El «deudor» de Occident era el SIGNO del EIAC, no una deuda (24/09/2026).** Occident manda bruto negativo
  ...
  `estadoCuadre` contrasta ya con `remesaInferida`: casa → `cuadra`; otra cifra → `descuadra`; sin abono → `deudor`
  (que no manda a reclamar). **La cifra fiscal NO se ha tocado**: el signo solo cambia el veredicto del cuadre.
