...
export const CRON_JOBS: CronJob[] = [
  ...
  // Segunda pasada a las 20:30 de Madrid: las subastas del Portal cierran entre
  // las 18:00 y las 19:30 (con prórroga de hasta 24 h si entra una puja al
  // final), así que esta es la que cuenta el desenlace EL MISMO DÍA — que es
  // cuando interesa saber si hubo pujas y por cuánto se fue. La de las 09:00
  // recoge las que se prorrogaron y las que publicaron el certificado tarde.
  { path: '/api/cron/subastas-cierre', schedule: '30 18 * * *' },
