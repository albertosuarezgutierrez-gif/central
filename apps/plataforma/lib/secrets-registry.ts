...
export const SECRETS_REGISTRY: SecretEntry[] = [
  ...
  { name: 'GITHUB_TOKEN', tipo: 'api-externa', proposito: 'Lee y commitea la landing de housesevillana (repo house-sevillana-landing) para el agente SEO.', verticales: ['sivra', 'plataforma'], dondeVive: 'vercel-proyecto', proyecto: 'sivra + plataforma', editable: true, vercelProject: 'sivra', vercelProjects: ['plataforma'], nota: 'Runtime env que leen seo-landing.ts de sivra Y plataforma (mismo valor en ambos). Es un PAT con acceso al repo de la landing; NO confundir con el GITHUB_TOKEN auto-inyectado en GitHub Actions. La regla "usar GH_PAT" aplica al código de ia-rest, no a estas dos rutas SEO ya estandarizadas.' },
