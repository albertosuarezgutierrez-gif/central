...
export const SECRETS_REGISTRY: SecretEntry[] = [
  ...
  { name: 'PORTAL_SUBASTAS_COOKIE', tipo: 'api-externa', proposito: 'Cookie de una sesión iniciada a mano en el Portal de Subastas del BOE: destapa el IMPORTE de la puja en vivo (sin ella el Portal publica solo el sí/no).', verticales: ['plataforma'], dondeVive: 'vercel-proyecto', proyecto: 'plataforma', editable: true, vercelProject: 'plataforma', nota: 'Opcional y CADUCA: sin ella la vigilancia de pujas sigue funcionando en modo sí/no, que es lo que se publica anónimamente. No es un secreto de firma.' },
