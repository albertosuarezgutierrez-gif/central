...
// Vanesa y el ingreso no contó. Dos señales alimentan la tabla `reservas_correo_booking`
    ...
    if (!f.avisada_at) {
      ...
      const msg = tipo === 'nueva'
        ? [
            ...
            f.property_id ? 'La he marcado ⚠️ en la intranet de Vanesa hasta que Smoobu la tenga.' : '⚠️ No he podido identificar el piso por el nombre del anuncio — revisa en Booking cuál es.',
          ].join('\n')
        : [
