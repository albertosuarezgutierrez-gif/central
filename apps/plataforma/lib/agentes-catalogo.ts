...
export const CRONS_VERCEL: AgenteInfo[] = [
  ...
  { id: 'subastas', nombre: 'Radar de subastas de inmuebles', tipo: 'cron-vercel',
    funcion: 'Ingiere las alertas del Portal de Subastas del BOE del correo, calcula el coste real y avisa',
    cadencia: 'Diaria 06:00/06:30/08:00/09:00', disparo: 'Cron Vercel', entrega: 'accion-directa', telegram: true,
