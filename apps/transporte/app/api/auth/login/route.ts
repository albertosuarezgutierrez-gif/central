...
export async function POST(req: NextRequest) {
  ...
  // Sesión STATELESS (no escribimos session_jti para no pisar la sesión de plataforma, que
  // comparte la tabla cuentas). El token va firmado con el secreto propio de transporte.
