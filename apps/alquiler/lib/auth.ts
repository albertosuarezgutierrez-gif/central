...
export const COOKIE_NAME = 'alquiler_session'
...
const SECRET = () =>
  process.env.ALQUILER_SESSION_SECRET ||
  (process.env.NODE_ENV === 'production'
    ? (() => {
        throw new Error('ALQUILER_SESSION_SECRET no configurado')
      })()
    : 'alquiler-dev-secret-change-in-prod')
