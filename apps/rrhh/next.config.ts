...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ['@central/core-ai', '@central/core-email', '@central/core-firma', '@central/core-storage', '@central/module-documental', '@central/module-rrhh', '@central/module-chat'],
