...
export default async function Page() {
  ...
  const documentos = await listarExpediente(s.empresa_id, s.empleado_id, ACTOR_TITULAR)
  ...
  return <ExpedienteEmpleado visibles={visibles} subibles={subibles} inicial={JSON.parse(JSON.stringify(documentos))} />
}
