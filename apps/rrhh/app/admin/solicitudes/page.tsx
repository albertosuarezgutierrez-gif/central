...
export default async function Page() {
  ...
  return <SolicitudesClient inicial={JSON.parse(JSON.stringify(solicitudes))} logoUrl={branding.logo_url} nombreEmpresa={branding.nombre} colorPrimario={branding.color_primario} />
}
