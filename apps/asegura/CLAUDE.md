...
`seguros.aviso_web` (`prisma/sql/2026-09-24d_aviso_web.sql`, **SIN APLICAR**; probada contra la BD
en un bloque abortado: guardas OK, `crm_seguros` sin acceso). Correo cifrado; la llave de confirmar
...
**Para encender, en este orden:** aplicar el SQL → `ASEGURA_AVISOS_WEB_ACTIVOS=1` en `central-asegura`
