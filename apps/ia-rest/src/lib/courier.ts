...
import type { PrintPayload, ItemCuenta, TicketCuentaParams } from '@central/core-receipts'
import { crearReciboDigital, type ReciboSnapshot } from '@/lib/recibo'

// Re-exporta los generadores de cocina migrados a @central/core-receipts para que
// los consumidores que los importan desde '@/lib/courier' sigan compilando.
// `generarEscPosCuenta` + `CuentaParams` (ticket de cuenta con e-recibo) se quedan
// en este fichero porque siguen evolucionando aquí (no migrados en Fase 1).
export { generarEscPos, generarTextoPlano, generarTicketCuenta } from '@central/core-receipts'
export type { PrintPayload, ItemCuenta, TicketCuentaParams } from '@central/core-receipts'
