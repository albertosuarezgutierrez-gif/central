...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    async function enviar() {
      ...
      // GA4: conversión por formulario
      try { (window as any).gtag?.('event', 'generate_lead', { method: 'formulario', origen: 'landing-principal' }) } catch {}
    }
    ...
    document.querySelectorAll<HTMLElement>('[data-ga]').forEach((el) => {
      el.addEventListener('click', () => gaEvent(el.getAttribute('data-ga') || 'cta_click', { origen: 'landing-principal' }))
    })
...
<section class="hero" style="padding-bottom:0">
  ...
  <div class="fi d3" style="margin-top:48px;display:flex;gap:32px;flex-wrap:wrap;justify-content:center;padding-top:28px;border-top:1px solid var(--border);max-width:1180px;margin-left:auto;margin-right:auto;width:100%">
    ...
    <div style="text-align:center">
      <div style="font-family:'Newsreader',serif;font-size:36px;font-weight:200;color:var(--ink);letter-spacing:-1px;line-height:1">7.850</div>
      <div style="font-size:10px;color:var(--ink3);font-weight:500;letter-spacing:.1em;text-transform:uppercase;margin-top:4px">Negocios cerrados<br>en España en 2024</div>
    </div>
    <div style="text-align:center">
        ...
        <div class="form-card">
          ...
          <div class="form-body" id="formBody">
            ...
            <div style="text-align:center;margin-top:14px;font-size:12px;color:var(--ink3)">o más rápido —
              <a href="https://wa.me/34637349990?text=Hola%2C%20quiero%20ver%20una%20demo%20de%20ia.rest" target="_blank" rel="noopener" data-ga="click_whatsapp" style="color:var(--green);font-weight:600;text-decoration:none">escríbenos por WhatsApp →</a>
            </div>
          </div>
...
<div class="sticky-cta">
  <a href="#contacto" class="sc-demo" data-ga="click_demo">Pedir demo</a>
  <a href="https://wa.me/34637349990?text=Hola%2C%20quiero%20ver%20una%20demo%20de%20ia.rest" target="_blank" rel="noopener" class="sc-wa" data-ga="click_whatsapp"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M.057 24l1.687-6.163a11.867 11.867 0 0 1-1.587-5.946C.16 5.335 5.495 0 12.05 0a11.82 11.82 0 0 1 8.413 3.488 11.82 11.82 0 0 1 3.48 8.414c-.003 6.557-5.338 11.892-11.893 11.892a11.9 11.9 0 0 1-5.688-1.448L.057 24zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884a9.86 9.86 0 0 0 1.51 5.26l-.999 3.648 3.978-1.045zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z"/></svg> WhatsApp</a>
</div>
