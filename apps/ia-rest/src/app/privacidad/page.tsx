    ...
    <>
      ...
      <div className="doc" style={s}>
        ...
        <div className="ia-box">
          ...
          <p><strong>Estructuración de comandas (LLM):</strong> El texto transcrito se envía a modelos de lenguaje (NVIDIA NIM con z-ai/glm-5.2, con fallback a otros modelos de lenguaje) para identificar mesa, productos y cantidades. Ningún dato de esta fase permite identificar individualmente a personas físicas.</p>
