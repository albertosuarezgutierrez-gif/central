...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ['@central/core-ai', '@central/core-fiscal', '@central/core-payments', '@central/core-push', '@central/module-contabilidad', '@central/module-crm', '@central/module-materiales', '@central/module-horario', '@central/module-asn', '@central/module-presupuestos', '@central/module-proveedores', '@central/module-feedback', '@central/module-organizador-trabajo'],
