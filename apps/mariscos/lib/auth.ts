...
export const COOKIE_NAME = 'mariscos_session'
...
const SECRET = () =>
  process.env.MARISCOS_SESSION_SECRET ||
  (process.env.NODE_ENV === 'production'
    ? (() => {
        throw new Error('MARISCOS_SESSION_SECRET no configurado')
      })()
    : 'mariscos-dev-secret-change-in-prod')
