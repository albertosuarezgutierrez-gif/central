...
export const metadata: Metadata = {
  title: 'Aviso legal',
  description:
    'Titular, objeto, condiciones de uso, propiedad intelectual, ley aplicable y fuero de la web de Grupo ASegura, correduría de seguros que media en toda España.',
